...
<div>
    <article class="event-details-border">
        ...
        <form class="event-upload-form" id="event-upload-form" autocomplete="off" action=".\process-event.php"
            method="post">

            <input value=<?php echo ("'".$account->getRegisteredClubSportID()."'");?> id="sport-type" name="sport-type"
                hidden />
