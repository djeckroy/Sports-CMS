<div class="administrator-modal-background">
	<div class="administrator-modal-content">

	  	<div class="administrator-modal-header">
	  	  <div class="administrator-modal-exit-button" onclick="hideAdministratorModal()">+</div>
	  	</div>
